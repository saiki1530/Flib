                                    ...
                                    <div class="tab-pane fade show active" id="tab1" role="tabpanel"
                                        ...
                                        <div class="table-responsive">
                                            <table id="tab1-listing" class="table">
                                                <form action="{{ route('admin.addfd') }}" method="post"
                                                    class="col-7 m-auto" enctype="multipart/form-data"><br>
                                                    <p> Môn học: <input name="name" class="form-control" value="">
                                                    </p>

                                                    <p> Số lượng: <input name="amount" class="form-control" value="">
                                                    </p>
                                                    ...
                                                    <center>
                                                        <p><button type="submit" class="btn btn-primary">Thêm môn học</button>
