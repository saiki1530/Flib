...
<div class="content-wrapper">
    <div class="row">
        ...
        <div class="col-lg-12 m-auto">
            ...
            <div class="card">
            <div class="card-body">
                <h5 class="card-title">Chỉnh sửa dự án - Mã: {{$project->id}}</h5>
                    ...
                    <div class="container-fluid">
                        <form action="{{route('admin.project.update', $project->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ $project->name }}" type="text" name="name" id="name" class="form-control {{$errors->has('name')?'is-invalid':''}}">
                                                    @if ($errors->has('name'))
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ $project->product_slug }}" type="text" name="product_slug" id="product_slug" class="form-control {{$errors->has('product_slug')?'is-invalid':''}}">	
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control {{$errors->has('id_field')?'is-invalid':''}}" name="id_field">
                                                    @foreach ($fields as $field )
                                                            @if ($project->id_field == $field->id)
                                                                <option value="{{$field->id}}" selected>{{$field->id}} - {{$field->name}}</option>
                                                            @else 
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ $project->video }}" type="text" name="video" id="video" class="form-control {{$errors->has('video')?'is-invalid':''}}">
                                                    @if ($errors->has('video'))
                                                    <div class="invalid-feedback">
                                                        {{ $errors->first('video') }}
                                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ $project->ppt }}" type="text" name="ppt" id="ppt" class="form-control {{$errors->has('ppt')?'is-invalid':''}}">
                                                    @if ($errors->has('ppt'))
                                                    <div class="invalid-feedback">
                                                        {{ $errors->first('ppt') }}
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ $project->source }}" type="text" name="source" id="source" class="form-control {{$errors->has('source')?'is-invalid':''}}">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ $project->technical }}" type="text" name="technical" id="technical" class="form-control {{$errors->has('technical')?'is-invalid':''}}">
                                        ...
                                        <div class="row mt-3 mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input mt-2" type="radio" name="visibility" id="gridRadios1" value="1" {{$project->visibility?"checked":""}}>
                                                    <label class="form-check-label" for="gridRadios1">
                                                        <i class="bi bi-check-circle btn btn-success rounded-circle"></i>
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input mt-2" type="radio" name="visibility" id="gridRadios2" value="0" {{$project->visibility?"":"checked"}}>
                                            ...
                                            <label class="col-form-label col-sm-2">Trạng thái xét duyệt</label>
                                            <div class="col-md-4">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input mt-2" type="radio" name="status" id="gridRadios3" value="1" {{$project->status?"checked":""}}>
                                                    <label class="form-check-label" for="gridRadios3">
                                                        <i class="bi bi-check-circle btn btn-success rounded-circle"></i>
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input mt-2" type="radio" name="status" id="gridRadios4" value="0" {{$project->status?"":"checked"}}>
                                        ...
                                        <div class="mb-3 row">
                                            <label>Mô tả</label> 
                                            <textarea id="introduction" name="introduction" rows="5" class="form-control {{$errors->has('introduction')?'is-invalid':''}}">{{$project->introduction}}</textarea> 
                            ...
                            <div class="pb-3 pt-3">
                                ...
                                <a type="cancle" href="{{route('admin.project.index')}}" class="btn btn-outline-dark ml-3">Hủy</a>
                            </div>
                        </form>
